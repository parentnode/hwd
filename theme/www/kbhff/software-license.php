...
<body>
	...
	<div class="">
		<h2>Introduction</h2>
		<p>In the first week of the Holistic Development Course, we discussed software licenses: what open- and closed-source means, what the pros and cons of different license types are and what license type we should recommend for the KBHFF project. This document outlines our findings briefly.</p>
	</div>
	<div class="">
		<h2>Understanding license types</h2>
		<h3>What is opensource?</h3>
		<p>"Open Source Software is software that can be freely used, changed, and shared (in modified or unmodified form) by anyone."</p>
		<p>We have collated some relevant links where you can read more about different license types:
