...
<div class="">
	...
	<p>You can find a bunch of text editors out there today, and the
		...
		overwhelming task. As you try to find your way in the jungle
		of text editors, you have to consider their advantages and
		disadvantages when choosing the right one. Here are some
		important questions to consider:
	</p>
	<ul>
		<li>Do you want to pay money for the text editor?</li>
		<li>Do you have any idealistic and political concerns when
			choosing the right technology?</li>
		<li>Does the text editor have to be userfriendly with an
			easy-to-use userinterface?</li>
		<li>Does customization and personalization of the text editor
			mean a lot to you?</li>
		<li>And what about performance when working with large projects?
	</ul>
	<p>Below you can find a summary with focus on these questions of
		the 4 most popular text editors.</p>
</div>
<div ="">
	<h3>Atom</h3>
	<p>
		Atom is free and open source, so if you care about open source
		and free softwares, this is the perfect choice. It is developed
		by the <strong>Github community</strong>, with the members
		contributing to the <strong>many add-on packages</strong> that
		are all developed by the community. This means that you can
		extend Atom's capabilities and features with a high degree of
		freedom and choices <strong>(6.452 packages and themes)</strong>.
		It furthermore has a very userfriendly design, which is completely
		customizable. This means that you can make it look just the way
		you like it and that it is <strong>very easy to pick up for a
		beginner</strong>. An issue which is important to consider is the
