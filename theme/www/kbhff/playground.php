...
<body>
	...
	<div>
		...
		<ul>
			<li>
				<p>The project must be cloned to /srv/sites/parentnode/class-test on Mac and to C:\srv\sites\parentnode\class-test on Windows.</p>
			</li>

			<li>
				<p>After having cloned the class-test project, enable the site on your computer by following <a href="https://parentnode.dk/blog/enable-a-site">this guide.</a></p>
			</li>
			<li>
				<p>Once you have cloned and enabled the site, you can visit <a href="http://class-test.local">class-test </a>in your browser and see the class pages.</p>
			</li>

			<li>
				<p>Inside the new class-test project you will find the "HTML"-pages (the ones shown in the browser) in src/www. Though the files are named .php, they actually contain HTML. You can make a copy of "new-participant.php", using your own name - and this will be your personal test page onwards.</p>
			</li>
			<li>
				<p>The purpose is for you to have a simple page where you can write your first HTML and see the result in your own browser. It is also a way for you to get some experience with using Git to send your changes back to the group.</p>
			</li>
			<li>
				<p>Create your own file, make some changes to your file and commit and push the changes back to Github by using the GitHub account. Look inside the other participant-files for inspiration on HTML.</p>
			</li>
		</ul>
	</div>
	<div>
		...
		<ul>
			<li>
				<p>Leave pre-filled values as they are "except for System mail", where you enter your private email. Root database password: The one you entered when installing the webstack.</p>
			</li>
			<li>
				<p>New Janitor database password - whatever you want.</p>
			</li>
			<li>
				<p>Mail username: A Google-based email address.</p>
			</li>
			<li>
				<p>Mail password: The password for the Google-based email.</p>
			</li>
		</ul>
		...
		Note down any problems, questions or comments you have during these assignments. We will use your feedback to improve the process for any new participants in the KBHFF development along the way. If you think something is hard to understand, others are likely to think the same.
	</div>
</body>
