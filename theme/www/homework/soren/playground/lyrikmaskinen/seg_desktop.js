...
Util.Events = u.e = new function() {
	...
	this._inputStart = function(event) {
		...
		if(this.e_hold) {
			debugger
			this.t_held = u.t.setTimer(this, u.e._held, this.timeOut);
		}
	...
	this.hold = function(node, _options) {
		...
		node.e_hold_options.timeOut = node.e_hold_options.timeOut ? node.e_hold_options.timeOut : 750;
		node.e_hold = true;
